...
#elif WRAPPED_AUDIO_HAL_VERSION == ANDROID_VERSION(4, 1)
#include "include/4.0/system/audio.h"
#include "include/4.1/hardware/audio.h"
#elif WRAPPED_AUDIO_HAL_VERSION == ANDROID_VERSION(4, 2)
#include "include/4.2/system/audio.h"
#include "include/4.2/hardware/audio.h"
#elif WRAPPED_AUDIO_HAL_VERSION == ANDROID_VERSION(4, 3)
#include "include/4.3/system/audio.h"
